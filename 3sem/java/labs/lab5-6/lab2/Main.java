...
public class Main {
    ...
    static Logger collectionslogger = new Logger("collectionslogger.txt", true);
    ...
    public static List<Integer> arraylistadd = new ArrayList<>();
    public static List<Integer> arraylistaddtotal = new ArrayList<>();
    public static List<Integer> arraylistdelete = new ArrayList<>();
    public static List<Integer> arraylistdeletetotal = new ArrayList<>();
    public static List<Integer> linkedlistadd = new ArrayList<>();
    public static List<Integer> linkedlistaddtotal = new ArrayList<>();
    public static List<Integer> linkedlistdelete = new ArrayList<>();
    public static List<Integer> linkedlistdeletetotal = new ArrayList<>();
    ...
    public static ArrayList<Object> addListTest(int length) {
        ...
        arraylistadd.add(totaltime / length);
        arraylistaddtotal.add(totaltime);
        return arraylist;
    }
    ...
    public static void deleteListTest(ArrayList<Object> arraylist) {
        ...
        arraylistdelete.add(totaltime / (sizeofstartarray / 10));
        arraylistdeletetotal.add(totaltime);
    }
    ...
    public static LinkedList<Object> addLinkedListTest(int length) {
        ...
        linkedlistadd.add(totaltime / length);
        linkedlistaddtotal.add(totaltime);
        return linkedlist;
    }
    ...
    public static void deleteLinkedListTest(LinkedList<Object> linkedlist) {
        ...
        linkedlistdelete.add(totaltime / (sizeofstartarray / 10));
        linkedlistdeletetotal.add(totaltime);
    }
    ...
    public static void makeDopTest(int value) {
        ...
        System.out.println("Время до увеличения размера: " + totaltime);
        ...
        System.out.println("Время после увеличения размера: " + totaltime);
